...
import { DoctorProfile } from '@/entities/user/model/types';
import EditableForm from '@/shared/ui/EditableForm';
import { observer } from 'mobx-react-lite';
import { toJS } from 'mobx';
import { getSpecializationsList } from '@/entities/specializaton/api';
import { Specialization } from '@/entities/specializaton/model/types';
